...
trigger: auto+manual
version: 1.0.0
description: "Use when creating new skills, editing existing skills, or verifying skills work before deployment. Chat triggers: 'create a skill', 'write a skill', 'new skill', 'edit skill', 'skill development', 'skill authoring', 'add a skill', 'modify skill', 'skill template', 'skill file', 'update skill definition', 'validate skill', 'skill writing', 'authoring skills'."
---
...
- `description`: Third-person, describes ONLY when to use (NOT what it does)
  ...
  - Include specific triggers, situations, and contexts
...
**Why this matters:** When a description summarizes the skill's workflow, the agent may follow the description instead of reading the full skill content. A description saying "code review between tasks" caused the agent to do ONE review, even though the skill's flowchart clearly showed TWO reviews.
...
# ✅ GOOD: Reference --help
search supports multiple modes and filters. Run --help for details.
```
...
**Why no @ links:** `@` syntax force-loads files immediately, consuming 200k+ context before they're needed.
...
- Testing techniques → Python (our project language)
