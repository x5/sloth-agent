...
trigger: auto+manual
version: 1.0.0
description: "Use when starting feature work that needs isolation from current workspace or before executing implementation plans - creates isolated git worktrees with smart directory selection and safety verification. Chat triggers: 'worktree', 'git worktree', 'isolated workspace', 'separate branch', 'parallel development', 'isolate this work', 'new worktree', 'work on feature in isolation', 'clean environment', 'git isolation', 'branch worktree', 'worktree setup'."
---
...
| No project config | Skip dependency install |
...
- **Fix:** Auto-detect from project files (pyproject.toml, package.json, etc.)
...
- **writing-plans** - REQUIRED before executing any tasks
