...
trigger: auto+manual
version: 1.0.0
description: "Use when you have a spec or requirements for a multi-step task, before touching code. Chat triggers: 'write a plan', 'planning', 'implementation plan', 'technical plan', 'plan before coding', 'break down the task', 'step by step plan', 'what are the steps', 'plan the work', 'task breakdown', 'architectural plan', 'implementation strategy', 'how do we build this', 'action plan', 'dev plan'."
---
...
- Execute tasks in this session with checkpoints for review
