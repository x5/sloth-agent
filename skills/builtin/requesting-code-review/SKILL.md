...
Dispatch a code reviewer subagent to catch issues before they cascade. The reviewer gets precisely crafted context for evaluation — never the session's history. This keeps the reviewer focused on the work product, not the thought process, and preserves context for continued work.
...
Use the code-reviewer template at `skills/builtin/requesting-code-review/code-reviewer.md`
...
[Dispatch code reviewer subagent with code-reviewer template]
