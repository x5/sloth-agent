...
```
RED (Write failing test) -> Verify RED -> GREEN (Minimal code) -> Verify GREEN -> REFACTOR -> Next
```
...
When adding mocks or test utilities, read the anti-patterns reference in this skill directory: `testing-anti-patterns.md`
