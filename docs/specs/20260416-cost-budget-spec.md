...
| **DeepSeek** | deepseek-v4 | TBD | TBD | 编码旗舰（即将发布，1T MoE） |
| **Qwen** | qwen3.6-plus | 0.001 | 0.002 | 最新旗舰，代码增强（2026-04） |
...
| **GLM** | glm-5.1 | 0.002 | 0.004 | 最新旗舰，编程+8h持续工作（2026-03） |
| **GLM** | glm-5 | 0.001 | 0.002 | 新一代旗舰（2025-07） |
| **GLM** | glm-4.5-flash | 0 | 0 | 免费版 |
| **MiniMax** | minimax-m2.7 | 0.002 | 0.004 | 最新旗舰，自进化能力（2026-03） |
...
class BudgetAwareLLMRouter:
    ...
    def __init__(self, config: Config, cost_tracker: CostTracker,
        ...
        self.mid_models = ["qwen3.6-plus", "glm-5", "minimax-m1"]
        self.expensive_models = ["glm-5.1", "kimi-k2.5", "minimax-m2.7", "mimo-v2-pro", "claude-sonnet"]
